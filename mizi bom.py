...
\033[1;92m[+] AUTHOR       :   RAHAT
\x1b[1;92m[+] FACEBOOK     :   Rahat mizi 
\x1b[1;92m[+] GITHUB       :   RAHAT-CYBAR 
\x1b[1;12m[+] TEAM         :   \33[1;42  RAHAT\33[0m
...
if 'Rifat'==user and 'Ritu '==pas:
        ...
        time.sleep(3)
        os.system('xdg-open https://www.facebook.com/RAHAT.OFFICIAL.ACCOUNT')
        os.system("python RAHAT.py")
#
...
os.system("xdg-open https://www.facebook.com/md.sabur.56027")
